...
export default function Sidebar() {
  ...
  const navLinks: NavLink[] = [
    ...
    { href: "/dashboard/donations/import", icon: "📥", label: "Donation imports" },
    { href: "/dashboard/reconciliation", icon: "🔒", label: "Reconciliation" },
    { href: "/dashboard/gift-aid", icon: "🎁", label: "Gift Aid" },
    { href: "/dashboard/donors", icon: "👤", label: "Donors" },
    { href: "/dashboard/appeals", icon: "📣", label: "Appeals" },
